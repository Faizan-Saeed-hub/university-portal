...
const API = (process.env.REACT_APP_API_URL || "https://university-admission-support-system.up.railway.app") + "/api/admin";
const BASE = process.env.REACT_APP_API_URL || "https://university-admission-support-system.up.railway.app";

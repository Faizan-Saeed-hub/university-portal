...
const Eligibility = () => {
  ...
  useEffect(() => {
    ...
    fetch((process.env.REACT_APP_API_URL || "https://university-admission-support-system.up.railway.app") + "/universities")
      ...
      if (selectedUni && department) {
        ...
        try {
          ...
          const res = await fetch(
            (process.env.REACT_APP_API_URL || "https://university-admission-support-system.up.railway.app") + "/get-entry-test-rule",
            {
              method: "POST",
  ...
  const handleCheckEligibility = async () => {
    ...
    try {
      ...
      const response = await fetch(
        (process.env.REACT_APP_API_URL || "https://university-admission-support-system.up.railway.app") + "/check-eligibility",
        {
          method: "POST",
      ...
      if (currentUserEmail) {
        try {
          await axios.put(`${process.env.REACT_APP_API_URL || "https://university-admission-support-system.up.railway.app"}/api/users/${currentUserEmail}`, {
            merit: data.merit
          });
